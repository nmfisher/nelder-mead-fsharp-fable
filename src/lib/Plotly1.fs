...
module _d3 = D3
let [<Import("Plots","..")>] Plots: StaticPlots = jsNative
let [<Import("d3","..")>] d3: obj = jsNative
...
type [<AllowNullLiteral>] IExports =
    ...
    abstract addFrames: root: Root * frames: Array<obj> -> Promise<PlotlyHTMLElement>
...
type [<AllowNullLiteral>] Layout =
    ...
    abstract annotations: Array<obj> with get, set
    abstract shapes: Array<obj> with get, set
    abstract images: Array<obj> with get, set
    abstract updatemenus: TypeLiteral_03 with get, set
    abstract sliders: Array<obj> with get, set
...
type Color =
    U3<string, Array<string option>, Array<Array<string option>>>
...
module Color =
    ...
    let ofArray v: Color = v |> U3.Case3
    let isArray (v: Color) = match v with U3.Case3 _ -> true | _ -> false
    let asArray (v: Color) = match v with U3.Case3 o -> Some o | _ -> None
...
type [<AllowNullLiteral>] PlotData =
    ...
    abstract xy: Float32Array with get, set
    ...
    abstract line.shape: U6<string, string, string, string, string, string> with get, set
    ...
    abstract marker.sizemode: U2<string, string> with get, set
    abstract marker.showscale: bool with get, set
    abstract marker.line: obj with get, set
    ...
    abstract colorscale: U2<string, Array<float * string>> with get, set
...
type [<AllowNullLiteral>] PlotMarker =
    ...
    abstract colorscale: U3<string, ResizeArray<string>, Array<Array<U2<string, float>>>> with get, set
...
type [<AllowNullLiteral>] RangeSelector =
    inherit Label
    abstract buttons: Array<obj> with get, set
    abstract visible: bool with get, set
    abstract x: float with get, set
    abstract xanchor: U4<string, string, string, string> with get, set
    abstract y: float with get, set
...
type [<AllowNullLiteral>] Scene =
    ...
    abstract annotations: U2<obj, Array<obj>> with get, set
    abstract captureevents: bool with get, set
...
type [<AllowNullLiteral>] Slider =
    ...
    abstract steps: Array<obj> with get, set
